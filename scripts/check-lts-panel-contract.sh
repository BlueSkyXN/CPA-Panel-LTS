...
require_file_contains scripts/smoke-lts-panel.py "client-usage-aggregation: sum"
require_file_contains scripts/smoke-lts-panel.py "mode: speed"
require_file_contains scripts/smoke-lts-panel-core.py "client-usage-aggregation: sum"
