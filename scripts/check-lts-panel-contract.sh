...
require_file_contains src/router/MainRoutes.tsx "path: '/usage/events'"
require_file_contains src/pages/UsageEventsPage.tsx "RequestEventsDetailsCard"
require_file_contains src/pages/UsageEventsPage.tsx "pageTimeRangeCustom"
require_file_contains src/components/layout/MainLayout.tsx "path: '/usage/events'"
...
require_file_contains src/services/api/usageQuery.ts "'/usage/query/capabilities'"
require_file_contains src/services/api/usageQuery.ts "'/usage/query/summary'"
require_file_contains src/services/api/usageQuery.ts "'/usage/query/details'"
...
require_file_contains scripts/smoke-lts-panel.py "run_oauth_plugin_model_refresh_smoke"
