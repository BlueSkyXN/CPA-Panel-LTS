...
require_file_contains src/utils/usage/cacheTokens.test.mjs "Panel derives uncached input"
...
require_file_contains src/components/usage/RequestEventsDetailsCard.tsx "getUsageUncachedInputTokenCount"
